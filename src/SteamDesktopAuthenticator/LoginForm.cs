...
public partial class LoginForm : Form
{
    ...
    public LoginForm(LoginType loginReason = LoginType.Initial, SteamGuardAccount account = null)
    {
        ...
        try
        {
            ...
            else if (LoginReason == LoginType.Import)
            {
        ...
        {
            MessageBox.Show("Failed to find your account. Try closing and re-opening SDA.", "Login Failed",
    ...
    private async void btnSteamLogin_Click(object sender, EventArgs e)
    {
        ...
        var result =
            MessageBox.Show("Steam account login succeeded. Press OK to continue adding SDA as your authenticator.",
                "Steam Login", MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
        ...
        while (linkResponse != AuthenticatorLinker.LinkResult.AwaitingFinalization)
        {
            ...
            {
                MessageBox.Show("Error adding your authenticator: " + ex.Message, "Steam Login", MessageBoxButtons.OK,
            ...
            switch (linkResponse)
            {
                ...
                case AuthenticatorLinker.LinkResult.MustConfirmEmail:
                    MessageBox.Show("Please check your email, and click the link Steam sent you before continuing.",
                        "Steam Login", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    break;

                case AuthenticatorLinker.LinkResult.GeneralFailure:
                    MessageBox.Show("Error adding your authenticator.", "Steam Login Error", MessageBoxButtons.OK,
                        MessageBoxIcon.Error);
                    Close();
                    return;
            }
        ...
        while (finalizeResponse != AuthenticatorLinker.FinalizeResult.Success)
        {
            ...
            var smsCode = smsCodeForm.txtBox.Text;
        ...
        MessageBox.Show("Mobile authenticator successfully linked. Please write down your revocation code: " +
                        linker.LinkedAccount.RevocationCode);
        Close();
    }
    ...
    private void HandleManifest(Manifest man, bool IsRefreshing = false)
    {
        ...
        if (IsRefreshing)
        {
            MessageBox.Show("Your session was refreshed.", "Steam Login", MessageBoxButtons.OK,
                MessageBoxIcon.Information);
        }
        else
        {
            MessageBox.Show(
                "Mobile authenticator successfully linked. Please write down your revocation code: " +
                account.RevocationCode, "Steam Login", MessageBoxButtons.OK);
        }
