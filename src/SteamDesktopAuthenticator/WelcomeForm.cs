...
public partial class WelcomeForm : Form
{
    ...
    private void btnImportConfig_Click(object sender, EventArgs e)
    {
        ...
        var userClickedOK = folderBrowser.ShowDialog();
        ...
        if (userClickedOK == DialogResult.OK)
        {
            ...
            var currentPath = Manifest.GetExecutableDir();
            ...
            foreach (var newPath in Directory.GetFiles(pathToCopy, "*.*", SearchOption.AllDirectories))
            {
            ...
            catch (ManifestParseException)
            {
                ...
                try
                {
                    MessageBox.Show("Your settings were unexpectedly corrupted and were reset to defaults.",
                        "Steam Desktop Authenticator", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                ...
                catch (MaFileEncryptedException)
                {
                    ...
                    MessageBox.Show(
                        "Sorry, but SDA was unable to recover your accounts since you used encryption.\nYou'll need to recover your Steam accounts by removing the authenticator.\nClick OK to view instructions.",
                        "Steam Desktop Authenticator", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    Process.Start(
                        @"https://github.com/Jessecar96/SteamDesktopAuthenticator/wiki/Help!-I'm-locked-out-of-my-account");
                    Close();
                    return;
                }
            }
            ...
            // All done!
            MessageBox.Show("All accounts and settings have been imported! Click OK to continue.", "Import accounts",
